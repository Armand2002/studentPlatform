export default function CTASection() {
  return (
    <section className="relative w-full overflow-hidden">
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-primary-800 via-primary-600 to-primary-500" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white">Pronto a migliorare il tuo percorso di studio?</h2>
        <p className="mt-3 text-white/90 max-w-2xl mx-auto">Unisciti a migliaia di studenti e tutor che prenotano, organizzano e imparano in modo più intelligente.</p>
