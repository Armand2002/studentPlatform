...
const variants: Record<Variant, string> = {
    primary: 'bg-primary text-white hover:bg-primary-600 focus:ring-2 focus:ring-primary-400',
    secondary: 'bg-gray-800 text-white hover:bg-gray-900 focus:ring-2 focus:ring-gray-500',
