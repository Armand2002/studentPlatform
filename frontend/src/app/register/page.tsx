  ...
  return (
    <div className="max-w-sm mx-auto">
      ...
      <form className="space-y-3">
        <input className="block w-full rounded-md border border-gray-300 px-3 py-2" placeholder="Nome" />
        ...
        <button className="w-full h-10 rounded-md bg-blue-600 text-white">Crea account</button>
      </form>
    </div>
  )
}
