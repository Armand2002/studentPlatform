          ...
          <CardContent className="p-6">
            ...
            <form className="space-y-4" onSubmit={onSubmit}>
              <div>
                ...
                <input className="block w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-primary-400" placeholder="es. mario.rossi@email.it" value={email} onChange={(e)=>setEmail(e.target.value)} />
              </div>
              <div>
              ...
              <button disabled={loading} className="w-full h-11 rounded-full bg-primary text-white hover:bg-primary-600 disabled:opacity-50">{loading ? 'Attendere…' : 'Accedi'}</button>
            </form>
